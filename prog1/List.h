...
int delElement(List L,
               int i); // deletes the ith element of L and return the data of
                       // it. throws an error if L has less than i+1 elements.
void appendList(List L, int i); // append i to the end of L.
                                // throws an error if L does not exist.

// Other functions ----------------------------
void printList(
    List L); // print all data of L with pattern "%d, " and a newline at the end
